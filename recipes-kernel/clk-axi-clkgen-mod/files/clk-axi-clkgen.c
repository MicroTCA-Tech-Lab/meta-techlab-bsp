	...
	unsigned long rate, unsigned long parent_rate)
{
	...
	printk(KERN_DEBUG "clk-axi-clkgen-mod: set rate to: %lu Hz\n", rate);
	printk(KERN_DEBUG "clk-axi-clkgen-mod: set parent_rate to: %lu Hz\n", parent_rate);
...
static int axi_clkgen_probe(struct platform_device *pdev)
{
	...
	printk(KERN_DEBUG "clk-axi-clkgen-mod: axi_clkgen_probe done\n");
